...
import getDrawerSxTransitionMixin from '../../layouts/mixins'
...
export default function DashboardSidebar({
  ...
  const shouldReduceDrawerMotion =
    theme.motion.reducedMotion === 'always' || (theme.motion.reducedMotion === 'system' && prefersReducedMotion)
  const drawerEnteringDuration = shouldReduceDrawerMotion ? 0 : theme.transitions.duration.enteringScreen
  const drawerLeavingDuration = shouldReduceDrawerMotion ? 0 : theme.transitions.duration.leavingScreen
  ...
  return (
    <DashboardSidebarContext.Provider value={sidebarContextValue}>
      ...
      <Drawer variant='permanent' sx={[{ display: { xs: 'none', md: 'block' } }, getDrawerSharedSx(false)]}>
